...
# get the first layer weight and the print it as the json file
first_layer_weights_df = pd.DataFrame()
for i in range(6):
    temp_w = model_new.get_weights()[0][i]
    first_layer_weights_df[i] = temp_w
print(first_layer_weights_df.to_json())
